        ...
        <AnimeOnAppear>
          <section className="my-24">
            ...
            <p className="h3 subtitle mb-4">
              ...
              frontend dev using React. Currently, I'm upgrading from web2 to
              web3 and learning Rust 🦀.`}
            </p>
            <p className="h3 subtitle mb-4">
            ...
            <p className="h3 subtitle mb-4">
              {`Beside programming, I'm interested in finance and enjoy to play
              sports like mountain bike or calisthenics.`}
            </p>
          </section>
        </AnimeOnAppear>
      </div>
